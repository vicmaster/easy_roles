...
Gem::Specification.new do |s|
  s.name = %q{simply_roles}
  s.version = "2.0.0.beta4"

  s.required_rubygems_version = Gem::Requirement.new(">= 1.2") if s.respond_to? :required_rubygems_version=
  s.authors = [%q{Platform45 and vicmaster}]
  s.date = %q{2015-04-8}
  s.description = %q{Simply role authorization in rails}
  s.email = %q{velazquezgaspar16@gmail.com}
  ...
  s.homepage = %q{https://github.com/vicmaster/simply_roles}
  s.rdoc_options = [%q{--line-numbers}, %q{--inline-source}, %q{--title}, %q{Easy_roles}, %q{--main}, %q{README.rdoc}]
  s.require_paths = [%q{lib}]
  s.rubyforge_project = %q{simply_roles}
  s.rubygems_version = %q{1.8.8}
  s.summary = %q{Simply roles authorization in rails}
